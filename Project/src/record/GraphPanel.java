...
public class GraphPanel extends JPanel {
   ...
   public GraphPanel(List<Double> scores, List<String> date) {
      this.scores = scores;
      this.date = date;
   }
...
//         int y1 = (int) (200-scores.get(i));
         graphPoints.add(new Point(x1, y1));
      }

      // draw white background
      g2.setColor(Color.CYAN); // 배경화면
...
//      }
      ...
      GraphPanel mainPanel = new GraphPanel(scores, date);
