...
public class Test01 extends JFrame {
   ...
   private static Vector<Infor> record = new Vector<Infor>();
   private List<String> date = new ArrayList<>();
   static {
      record.add(new Infor("user1", 3, 5, "2022-01-02"));
      record.add(new Infor("user1", 10, 10, "2022-01-03"));
      record.add(new Infor("user1", 8, 15, "2022-01-04"));
      record.add(new Infor("user1", 5, 15, "2022-01-05"));
   }
...
//      setVisible(true);
   ...
   private void toList(Vector<Infor> vector) {
      for(Infor info : vector) {
